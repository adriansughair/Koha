            ...
            <View style={Presets.HomeScreen}>
                  <View style={Presets.profileImageView}>
                   ...
                   <View style={Presets.OfferView}>
                            ...
                            <View>
                                    <Text style={Presets.price2} >2,500QAR </Text>                        
                            </View>
                            ...
                            <View style={{flexDirection: 'row',justifyContent:'space-between',width:'75%',margin:5}}>
                                <View>
                                    ...
                                    <Text style={Presets.DetailVal}>Male</Text> 
                                </View>
                                <View>
                                    <Text style={Presets.DetailHead}>Age</Text>
                                    <Text style={Presets.DetailVal} >1 Years</Text>
                                </View>
                                <View>
                                    <Text style={Presets.DetailHead}>Type</Text>
                                    <Text style={Presets.DetailVal} >Angora</Text>
                                </View>
                            </View>
